...
setLayout(null);
		...
		lblNewLabel.setBounds(466, 55, 63, 15);
		add(lblNewLabel);
		...
		lblNewLabel_1.setBounds(129, 39, 327, 31);
		add(lblNewLabel_1);
		
		
		
		JButton btnNewButton = new JButton("确定");
		btnNewButton.setBounds(204, 367, 93, 23);
		add(btnNewButton);
		
		JButton btnNewButton_1 = new JButton("取消");
		btnNewButton_1.setBounds(348, 367, 93, 23);
		add(btnNewButton_1);
		...
		checkBox.setBounds(180, 87, 85, 23);
		add(checkBox);
		
		JCheckBox checkBox_1 = new JCheckBox("3位");
		checkBox_1.setBounds(267, 87, 92, 23);
		add(checkBox_1);
		
		JCheckBox checkBox_2 = new JCheckBox("4位");
		checkBox_2.setBounds(360, 87, 81, 23);
		add(checkBox_2);
		
		JCheckBox checkBox_3 = new JCheckBox("5位");
		checkBox_3.setBounds(443, 87, 90, 23);
		add(checkBox_3);
		
		JCheckBox checkBox_4 = new JCheckBox("6位");
		checkBox_4.setBounds(535, 87, 81, 23);
		add(checkBox_4);
